...
beautiful.init("/home/andrew/.config/awesome/nightVale/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "3", "4", "5", "6", "7-admin", "8-chat", "9-media" }, s, awful.layout.layouts[1])
